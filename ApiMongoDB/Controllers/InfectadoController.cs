...
namespace ApiMongoDB.Controllers
{
    ...
    public class InfectadoController : ControllerBase
    {
        ...
        [HttpDelete("{data}")]
        public ActionResult ExcluirInfectado(DateTime data)
        {
            var builder = Builders<Infectado>.Filter.Where(_ => _.DataNascimento == data);
            _infectadosCollection.DeleteOne(builder);
